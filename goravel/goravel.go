...
func (c *Goravel) Init(p initPaths) error {
	root := p.rootPath
...
func (c *Goravel) checkDotEnv(path string) error {
...
func (c *Goravel) startLoggers() (*log.Logger, *log.Logger) {
